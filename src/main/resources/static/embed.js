...
(function () {
    const HOSTS = {
        customs: {
            ...
            sidebar: [
                { title: '处理队列', items: [['待归类', '184'], ['待复核', '36'], ['超时', '9']] },
                { title: '归档',     items: [['本月', '2,184'], ['本季', '6,109']] }
            ]
        },
        erp: {
            name: 'Acme ERP',
            ...
            sidebar: [
                { title: '待办',     items: [['采购审批', '24'], ['付款审批', '11'], ['对账', '7']] },
                { title: '周期',     items: [['本月凭证', '1,302'], ['本季', '4,876']] }
            ]
        },
        oa: {
            name: 'Acme OA',
            ...
            sidebar: [
                { title: '收件箱',   items: [['待审批', '17'], ['抄送我', '42'], ['已逾期', '3']] },
                { title: '今日',     items: [['会议', '4'], ['任务', '9']] }
            ]
        }
    };
